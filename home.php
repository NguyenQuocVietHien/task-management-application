...
<!-- Info boxes -->
 <div class="col-12">
  ...
  <hr>
  <?php
  // Initialize variables for filtering projects and tasks based on the user's role 
    $where = "";
          ...
          <div class="card-body p-0">
            <div class="table-responsive">
              <table class="table m-0 table-hover">
                ...
                // Define an array of project statuses
                $where = "";
                if($_SESSION['login_type'] == 2){
                  $where = " where manager_id = '{$_SESSION['login_id']}' ";
                }elseif($_SESSION['login_type'] == 3){
                ...
                // Retrieve project data from the database based on the user's role
