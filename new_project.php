...
<div class="col-lg-12">
 ...
 <!-- Input field for storing the project ID -->
		...
		<div class="row">
			...
			<!-- Status Input (Pending, On-Hold, Done) -->
          	<div class="col-md-6">
				<div class="form-group">
        ...
        <div class="row">
			...
			<!-- Project Manager Dropdown (For Admin Users) -->
           <div class="col-md-6">
            <div class="form-group">
      ...
      <?php else: ?>
		<!-- Hidden Field for Project Manager (For Non-Admin Users) -->
      	<input type="hidden" name="manager_id" value="<?php echo $_SESSION['login_id'] ?>">
      <?php endif; ?>
	  	<!-- Project Team Members Multiselect -->
          <div class="col-md-6">
            <div class="form-group">
