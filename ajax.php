...
include 'admin_class.php'; // Include the 'admin_class.php' file
$crud = new Action(); // Create an instance of the 'Action' class

// Check the value of the 'action' parameter and execute the corresponding function
if($action == 'login'){
	$login = $crud->login();
	if($login)
		echo $login;
